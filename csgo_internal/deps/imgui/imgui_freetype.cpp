...
bool ImFontAtlasBuildWithFreeTypeEx(FT_Library ft_library, ImFontAtlas* atlas, unsigned int extra_flags) {
	...
	render::current_load_stage_name = "Initializing fonts...";
	render::total_load_stages =
			atlas->ConfigData.Size + src_tmp_array.Size + src_tmp_array.Size + dst_tmp_array.Size + src_tmp_array.Size + src_tmp_array.Size;

	// 1. Initialize font loading structure, check font data validity
	for (int src_i = 0; src_i < atlas->ConfigData.Size; src_i++) {
		++render::current_load_stage;
