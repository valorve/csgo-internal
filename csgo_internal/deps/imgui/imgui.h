...
namespace ImGui
{
    ...
    IMGUI_API void          Render(ImDrawList*);                        
...
class ImDrawGradient {
public:
    virtual ImU32 GetColor(ImVec2 position) const = 0;
};

class ImDrawGradient_Linear : public ImDrawGradient {
private:
	ImVec4 Col0{};
	ImVec4 Col1{};
	ImVec2 Start{};
	...
	float Denom; // Cache the denominator to avoid computing it every time
public:
	ImDrawGradient_Linear(ImVec2 start, ImVec2 end, ImVec4 col0, ImVec4 col1)
		: Start(start), End(end), Col0(col0), Col1(col1) {
		ImVec2 diff = { End.x - Start.x, End.y - Start.y };
		Denom = diff.x * diff.x + diff.y * diff.y;
	}

	ImU32 GetColor(ImVec2 position) const override;
};
// Draw command list
...
struct ImDrawList
{
    ...
    IMGUI_API void  AddRect(const ImVec2& p_min, const ImVec2& p_max, const ImDrawGradient& paint, float rounding = 0.0f, ImDrawFlags flags = 0, float thickness = 1.0f);   // a: upper-left, b: lower-right (== upper-left + size)
    IMGUI_API void  AddRect(const ImVec2& p_min, const ImVec2& p_max, ImU32 col, float rounding = 0.0f, ImDrawFlags flags = 0, float thickness = 1.0f);   // a: upper-left, b: lower-right (== upper-left + size)
    IMGUI_API void  AddRectFilled(const ImVec2& p_min, const ImVec2& p_max, ImU32 col, float rounding = 0.0f, ImDrawFlags flags = 0);                     // a: upper-left, b: lower-right (== upper-left + size)
    IMGUI_API void  AddRectFilled(const ImVec2& p_min, const ImVec2& p_max, const ImDrawGradient& paint, float rounding = 0.0f, ImDrawFlags flags = 0);                     // a: upper-left, b: lower-right (== upper-left + size)
    IMGUI_API void  AddRectFilledMultiColor(const ImVec2& p_min, const ImVec2& p_max, ImU32 col_upr_left, ImU32 col_upr_right, ImU32 col_bot_right, ImU32 col_bot_left);
    IMGUI_API void  AddQuad(const ImVec2& p1, const ImVec2& p2, const ImVec2& p3, const ImVec2& p4, ImU32 col, float thickness = 1.0f);
    IMGUI_API void  AddQuadFilled(const ImVec2& p1, const ImVec2& p2, const ImVec2& p3, const ImVec2& p4, ImU32 col);
    IMGUI_API void  AddQuadFilledMultiColor(const ImVec2& p_upr_left, const ImVec2& p_upr_right, const ImVec2& p_bot_right, const ImVec2& p_bot_left, ImU32 col_upr_left, ImU32 col_upr_right, ImU32 col_bot_right, ImU32 col_bot_left);
    ...
    IMGUI_API void  AddCircleFilled(const ImVec2& center, float radius, const ImDrawGradient& paint, int num_segments = 0);
    IMGUI_API void  AddNgon(const ImVec2& center, float radius, ImU32 col, int num_segments, float thickness = 1.0f);
    IMGUI_API void  AddNgonFilled(const ImVec2& center, float radius, ImU32 col, int num_segments);
    IMGUI_API void  AddText(const ImVec2& pos, ImU32 col, const char* text_begin, const char* text_end = NULL);
    IMGUI_API void  AddText(const ImVec2& pos, const ImDrawGradient& paint, const char* text_begin, const char* text_end = NULL);
    IMGUI_API void  AddText(const ImFont* font, float font_size, const ImVec2& pos, ImU32 col, const char* text_begin, const char* text_end = NULL, float wrap_width = 0.0f, const ImVec4* cpu_fine_clip_rect = NULL);
    IMGUI_API void  AddText(const ImFont* font, float font_size, const ImVec2& pos, const ImDrawGradient& paint, const char* text_begin, const char* text_end = NULL, float wrap_width = 0.0f, const ImVec4* cpu_fine_clip_rect = NULL);
    IMGUI_API void  AddPolyline(const ImVec2* points, int num_points, ImU32 col, ImDrawFlags flags, float thickness);
    IMGUI_API void  AddPolyline(const ImVec2* points, int num_points, const ImDrawGradient& paint, ImDrawFlags flags, float thickness);
    IMGUI_API void  AddConvexPolyFilled(const ImVec2* points, int num_points, ImU32 col); // Note: Anti-aliased filling requires points to be in clockwise order.
    IMGUI_API void  AddConvexPolyFilled(const ImVec2* points, int points_count, const ImDrawGradient& paint);
    ...
    IMGUI_API void  AddImage(ImTextureID user_texture_id, const ImVec2& p_min, const ImVec2& p_max, const ImVec2& uv_min, const ImVec2& uv_max, ImDrawGradient& paint);
    ...
    inline    void  PathFillConvex(const ImDrawGradient& paint) { AddConvexPolyFilled(_Path.Data, _Path.Size, paint); _Path.Size = 0; }
    inline    void  PathStroke(ImU32 col, ImDrawFlags flags = 0, float thickness = 1.0f) { AddPolyline(_Path.Data, _Path.Size, col, flags, thickness); _Path.Size = 0; }
    inline    void  PathStroke(const ImDrawGradient& paint, ImDrawFlags flags = 0, float thickness = 1.0f) { AddPolyline(_Path.Data, _Path.Size, paint, flags, thickness); _Path.Size = 0; }
    ...
    IMGUI_API void  PrimRect(const ImVec2& a, const ImVec2& b, const ImDrawGradient& paint);      // Axis aligned rectangle (composed of two triangles)
    IMGUI_API void  PrimRectUV(const ImVec2& a, const ImVec2& b, const ImVec2& uv_a, const ImVec2& uv_b, ImU32 col);
    IMGUI_API void  PrimRectUV(const ImVec2& a, const ImVec2& b, const ImVec2& uv_a, const ImVec2& uv_b, ImDrawGradient& paint);
...
struct ImFont
{
    ...
    IMGUI_API void              RenderText(ImDrawList* draw_list, float size, ImVec2 pos, const ImDrawGradient& paint, const ImVec4& clip_rect, const char* text_begin, const char* text_end, float wrap_width = 0.0f, bool cpu_fine_clip = false) const;
